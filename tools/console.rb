...
bloodoath5 = BloodOath.new(cult3, person4, "2019=08-09")
bloodoath6 = BloodOath.new(cult3, person5, "2019-08-09")
bloodoath7 = BloodOath.new(manson, person5, "2019-08-09")
bloodoath8 = BloodOath.new(cult4, person6, "2019=08-09")
bloodoath9 = BloodOath.new(cult4, person7, "2019-08-09")
bloodoath10 = BloodOath.new(manson, person8, "2019-08-09")
bloodoath11 = BloodOath.new(cult3, person9, "2019=08-09")
bloodoath12 = BloodOath.new(cult4, person10, "2019-08-09")
