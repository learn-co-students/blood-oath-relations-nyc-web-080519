...
crossfit = Cult.new("Crossfit", "California", 2008, "You're guaranteed to get injured!", 14)
...
child = Follower.new("Kiddo", 9, "I don't know what a cult is")
teen = Follower.new("Teenage Dirtbag", 15, "I'm young and impressionable")
