...
f6 = Follower.new({name: 'alex', age: 18, life_motto: 'be whatever'})


c1 = Cult.new({name: 'cult1', location: 'nyc', founding_year: 2019, slogan: 'one of us', minimum_age: 20})
...
c1.recruit_follower(f1, "2000-01-01")
c3.recruit_follower(f1, "2000-01-01")
c4.recruit_follower(f1, "2000-01-01")
c1.recruit_follower(f3, "2005-01-01")
c2.recruit_follower(f3, "2002-01-01")
c2.recruit_follower(f2, "2007-01-01")

bo1 = BloodOath.new({cult: c5, follower: f3, initiation:"1999-01-05"})
